...
pub fn Security() -> Element {
    rsx! {
        Head { title: TITLE, description: DESCRIPTION, url: urls::route(ROUTE) }
            ...
            div { class: "
                ...
                div { class: "relative ml-auto flex space-x-8",
                    a {
                        ...
                        span { class: "fa-solid fa-envelope hover:text-melody-blue dark:hover:text-melody-purple text-4xl" }
                    }
                    a { href: "/keys/security", aria_label: "Security Key",
                        span { class: "fa-solid fa-key hover:text-melody-blue dark:hover:text-melody-purple text-4xl" }
                    }
                }
            }
        }
        div { class: "
            ...
            section { class: "my-12 w-full",
                ...
                h2 { class: "mt-6 text-2xl lg:text-4xl text-neutral-600 dark:text-neutral-400",
                    "Reporting"
                }
                p { class: "mt-6",
                ...
                p { class: "mt-6",
                    ...
                    span { class: "hover:text-melody-blue dark:hover:text-melody-purple underline",
                        "24 hours"
                    }
                ...
                p { class: "mt-6",
                    ...
                    ol { class: "mt-6 list-decimal list-inside",
                        ...
                        li { "Code is audited to find any potential similar problems." }
                        li {
                ...
                div { class: "mt-6 p-1 bg-linear-to-b from-melody-purple to-melody-blue rounded-lg",
                    pre { class: "p-4 overflow-auto rounded-lg bg-neutral-50 dark:bg-neutral-900",
                        {KEY}
                    }
                }
                h2 { class: "mt-6 text-2xl lg:text-4xl text-neutral-600 dark:text-neutral-400",
