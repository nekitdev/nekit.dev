...
pub const NEKO: &str = "/images/neko.png";
...
pub fn Home() -> Element {
    ...
    let neko = urls::static_route(NEKO);

    rsx! {
        Head { title: TITLE, description: DESCRIPTION, url: urls::root() }

        nav { aria_label: "Nagivagion", class: "absolute flex w-full",
            div { class: "
                    mx-auto
                    ...
                    py-4
                ",
                Link { to: Route::Home {}, class: "mr-auto text-2xl lg:text-3xl", {NAME} }
                div { class: "hidden lg:flex lg:space-x-8 text-xl",
                    Link {
                        to: Route::Blog {},
                ...
                div { class: "relative ml-auto flex space-x-8",
                    div { class: "hidden md:flex space-x-8",
                        a { href: "/youtube", aria_label: "YouTube",
                            span { class: "fa-brands fa-youtube text-youtube text-4xl" }
                        }
                        a { href: "/reddit", aria_label: "Reddit",
                            span { class: "fa-brands fa-reddit-alien text-reddit text-4xl" }
                        }
                        a { href: "/telegram", aria_label: "Telegram",
                            span { class: "fa-brands fa-telegram text-telegram text-4xl" }
                        }
                        a { href: "/chat", aria_label: "Discord",
                            span { class: "fa-brands fa-discord text-discord text-4xl" }
                        }
                        a { href: "/bluesky", aria_label: "Bluesky",
                            span { class: "fa-brands fa-bluesky text-bluesky text-4xl" }
                        }
                    }
                    a { href: "/github", aria_label: "GitHub",
                        span { class: "
                                fa-brands fa-github
        ...
        div { class: "
            ...
            section { class: "my-12 w-full lg:w-1/2",
                ...
                ul { class: "mt-6 flex flex-row flex-wrap gap-5",
                    Skill {
                        display: "Rust",
                        color: "bg-rust/20",
                        dot: "bg-rust",
                    ...
                    Skill { display: "Git", color: "bg-git/20", dot: "bg-git" }
                    Skill {
                        display: "Web (HTML/CSS/TS)",
                        color: "bg-web/20",
                        dot: "bg-web",
                    }
                    Skill { display: "SQL", color: "bg-sql/20", dot: "bg-sql" }
                }

                div { class: "mt-6 flex",

                    div { class: "w-auto px-4 py-2 rounded-md bg-linear-to-r from-melody-purple/20 to-melody-blue/20",
        ...
        footer { class: "mx-auto max-w-md sm:max-w-3xl lg:max-w-7xl px-4 sm:px-6 lg:px-8 py-16",
            div { class: "grid grid-cols-2 gap-y-4 lg:flex lg:flex-row lg:justify-between mb-8 text-lg",
                div { class: "ml-4 flex flex-col lg:ml-0",
                    h2 { class: "mb-2 text-neutral-600 dark:text-neutral-400", "Navigation" }
                    ul { class: "grid gap-2",
                        li {
                            Link {
                                class: "hover:text-melody-blue dark:hover:text-melody-purple",
                ...
                div { class: "ml-4 flex flex-col lg:ml-0",
                    h2 { class: "mb-2 text-neutral-600 dark:text-neutral-400", "Social" }
                    ul { class: "grid gap-2",
                        li {
                            a {
                                class: "hover:text-melody-blue dark:hover:text-melody-purple",
                ...
                div { class: "ml-4 flex flex-col lg:ml-0",
                    h2 { class: "mb-2 text-neutral-600 dark:text-neutral-400", "Contact" }
                    ul { class: "grid gap-2",
                        li {
                            a {
                                class: "hover:text-melody-blue dark:hover:text-melody-purple",
                ...
                div { class: "ml-4 flex flex-col lg:ml-0",
                    h2 { class: "mb-2 text-neutral-600 dark:text-neutral-400", "Security" }
                    ul { class: "grid gap-2",
                        li {
                            Link {
                                class: "hover:text-melody-blue dark:hover:text-melody-purple",
            ...
            p { class: "min-w-full text-neutral-600 dark:text-neutral-400 text-center text-xl mt-8",
